            ...
            <div>
                <div className="about">
                    ...
                    <p>På venstre sida av den raude streken på kartet i figur 1 ser ein nokre tradisjonelle trekk for fjordamål, dvs.
                        ...
                        dei svake hokjønnsorda får i dette området ending på {this.redWord("-a")} i bunden form eintal, t.d. {this.bracketWord("boka")} (sterkt) 
                        og {this.bracketWord("stova")} (svakt).</p>
                    ...
                    <p>Balestrand, Vik, Aurland, Leikanger og Sogndal har ein del språktrekk sams som gjer at me kan skilja
                        desse områda ut som midtresognsmål. For det første har dei tradisjonelt hatt diftonguttale 
                        av {this.bracketWord("i, u, y, o")}. Me kan då høyra ei vokalisk gliding mellom to vokalar i ord 
                        som {this.bracketWord("bil, bur, syr, stor")}, slik at uttalen vert nærast {this.bracketWord("beil, biur, søyr, stour")}. 
                        For det andre har dei i dette området ulik ending i bunden form av sterke og svake hokjønnssubstantiv. 
                        Bunden form eintal av det sterke substantivet {this.bracketWord("bok")}, får ending på {this.redWord("-i")}, 
                        men med diftongert uttale høyrest det ut som {this.redWord("-ei")} og blir til {this.bracketWord("boukei")}. 
                        Dei svake hokjønnssubstantiva endar derimot på ein ao-lyd. Eksempel på dette er substantivet {this.bracketWord("ei stova")} 
                        som då vert uttala {this.bracketWord("stovao")} i bunden form eintal. Når endingane er ulike alt etter om 
                        hokjønnsorda er sterke eller svake, snakkar me om delt hokjønnsbøying. Det tredje målmerket ein kan seia skil 
                        midtresognsmål frå indresognsmål, er at ein i Midtre Sogn uttalar 1. person personleg pronomen i eintal som {this.bracketWord("eg")}
                    ...
                    <p>Lærdal, Årdal og Luster (med unntak av Jostedalen), står då att som indresognsmål. Dei har i motsetnad til
                        ...
                        dei svake på monoftongen {this.redWord("-a")}, t.d. {this.bracketWord("stova")}. Luster er her eit unntak ved at også lustringane  brukar ein {this.redWord("ao-lyd")} i dei 
                        svake {this.bracketWord("stovao")} slik det er i midtresognsmåla.  Når det gjeld dei personlege pronomena, vert første person eintal i Indre Sogn uttala som {this.bracketWord("e")} og
                        fleirtal som {this.bracketWord("me")}.</p>

                    <h2>Sogndalsdialekten</h2>
                    <p>Finst det oppi alle desse fellestrekka noko som er særeige for talemålet i Sogndal? Nokre 
                        sogndalstrekk er sams for fleire bygder, men skil seg frå andre. Tradisjonelt har det vore 
                        ein del meir palatalisering av {this.redWord("k-lydar")} og {this.redWord("g-lydar")} (velarar) 
                        i dei andre bygdene i Midtre Sogn midtresognskommunane enn i Sogndal. Medan dei andre 
                        midtresognsmåla kan ha {this.bracketWord("bokji")} og {this.bracketWord("ingjen")}, 
                        vil ein i Sogndal helst høyra {this.bracketWord("boki")} og {this.bracketWord("ingen")} utan 
                        ein {this.redWord("j-haldig")} (palatalisert) lyd. I Sogndal er det elles typisk at ein høyrer 
                        ein {this.redWord("ø-lyd")} frå det som i norrønt var ein kort {this.redWord("y-lyd")}. Såleis 
                        vil ein t.d. i Sogndal kunna seia {this.bracketWord("søste, bøgd")}, medan ein i Vik 
                        høyrer {this.bracketWord("syste, bygd")} og {this.bracketWord("suste, bugd")} på Leikanger. 
                        I sogndalsdialekten er formene {this.bracketWord("heure, kjeure")} vanlege der ein gjerne i Aurland, 
                        Vik og Balestrand høyrer {this.bracketWord("høyrde, køyrde")} i preteritum av 
                        verba {this.bracketWord("køyra")} og {this.bracketWord("høyra")}. Medan Balestrand og Vik også 
                        har {this.redWord("-adne")} og {this.redWord("-edne")} som i {this.bracketWord("baotadne")} og {this.bracketWord("elvadne")},
                        lèt ein desse endingane ha berre éi staving, dvs. {this.redWord("-adn")} og {this.redWord("-edn")} som 
                        i {this.bracketWord("baotadn")} og {this.bracketWord("elvadn")}, i Leikanger, Aurland og Sogndal.
                        Til sist kan me nemna at sogndalsdialekten tradisjonelt sett har ein trong i-lyd i supinum av ein 
                        del sterke verb der dei andre midtresognsmåla får {this.redWord("-e")}. Sogndølene vil såleis kunna 
                        seia at dei har {this.bracketWord("ite middag")}, {this.bracketWord("lise ei bok")}, {this.bracketWord("dripe ein veps")} og {this.bracketWord("lige i ro")}.</p>
